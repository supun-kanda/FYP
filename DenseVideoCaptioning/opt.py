...
def default_options():
    ...
    options['feature_data_path'] = '/mnt/data/c3d_features/stride_64frame/sub_activitynet_v1-3_stride_64frame.c3d.hdf5'
    ...
    #options['init_from'] = './checkpoints/1/epoch04_7.29_04_lr0.001000.ckpt'
    options['init_from'] = './checkpoints/1/epoch04_8.53_04_lr0.001000.ckpt' #epoch04_8.53_04_lr0.001000.ckpt
    ...
    options['max_epochs'] = 5 # maximum epochs
    ...
    #options['train_caption'] = False # whether to train variables of captioning module
